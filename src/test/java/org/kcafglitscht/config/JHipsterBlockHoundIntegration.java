package org.kcafglitscht.config;
...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("org.kcafglitscht.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("org.kcafglitscht.security.DomainUserDetailsService", "createSpringSecurityUser");
